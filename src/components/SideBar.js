...
import { CalendarDays, ChartPie, ChevronRight, CircleDot, House, Layers, Lightbulb, Map, SquarePen, Table2, Wallpaper } from "lucide-react";
import Image from "next/image";
import Link from "next/link";

export default function SideBar() {
  return (
    <aside className="w-50 fixed left-0 top-0 h-screen bg-white flex flex-col items-center pt-4 pb-8 shadow-md">
      ...
      <div className="w-full text-left pl-6">
        ...
        <Link
          href="/"
          className="mt-2 flex items-center gap-1.5 rounded-full px-1.5 py-0.5"
        >
