...
export default function SideBar({ isOpen, onClose,theme }) {
  return (
    <>
      ...
      >
        <Image
          src={theme === "light" ? "/images/logo.png" : "/images/logo2.png"}
          alt="logo"
          width={140}
          height={140}
          className="pl-4"
        ...
        <div className="w-full text-left pl-4 pt-6">
          <p
            className={`text-[14px] ${theme === "light" ? "text-gray-500" : "text-gray-200"} mt-3`}
          >
            Main
          </p>
          <Link
          ...
          >
            ...
            />
            <span
              className={`text-[13px] ${theme === "light" ? "text-gray-500" : "text-gray-200"}`}
            >
              Dashboard
            </span>
